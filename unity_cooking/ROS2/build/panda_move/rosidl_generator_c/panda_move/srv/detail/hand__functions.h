...
#ifndef PANDA_MOVE__SRV__DETAIL__HAND__FUNCTIONS_H_
#define PANDA_MOVE__SRV__DETAIL__HAND__FUNCTIONS_H_
...
/// Create srv/Hand message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * panda_move__srv__Hand_Request__init().
...
/// Destroy srv/Hand message.
/**
 * It calls
 * panda_move__srv__Hand_Request__fini()
...
/// Check for srv/Hand message equality.
/**
...
/// Initialize array of srv/Hand messages.
/**
...
/// Finalize array of srv/Hand messages.
/**
 * It calls
 * panda_move__srv__Hand_Request__fini()
...
/// Create array of srv/Hand messages.
/**
 * It allocates the memory for the array and calls
 * panda_move__srv__Hand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Hand messages.
/**
 * It calls
 * panda_move__srv__Hand_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Hand message array equality.
/**
...
/// Copy an array of srv/Hand messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * panda_move__srv__Hand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_panda_move
...
/**
 * It calls
 * panda_move__srv__Hand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_panda_move
...
/**
 * It allocates the memory for the array and calls
 * panda_move__srv__Hand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_panda_move
...
/**
 * It calls
 * panda_move__srv__Hand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PANDA_MOVE__SRV__DETAIL__HAND__FUNCTIONS_H_
