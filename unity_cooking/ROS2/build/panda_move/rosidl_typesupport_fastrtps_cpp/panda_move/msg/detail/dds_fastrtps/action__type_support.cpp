...
#include "panda_move/msg/detail/action__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const panda_move::msg::Action & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  panda_move::msg::Action & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = panda_move::msg::Action;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const panda_move::msg::Action *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<panda_move::msg::Action *>(
    untyped_ros_message);
...
{
  return &panda_move::msg::typesupport_fastrtps_cpp::_Action__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, panda_move, msg, Action)() {
  return &panda_move::msg::typesupport_fastrtps_cpp::_Action__handle;
}
