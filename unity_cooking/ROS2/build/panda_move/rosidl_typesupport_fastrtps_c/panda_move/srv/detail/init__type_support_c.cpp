...
#include "panda_move/srv/detail/init__rosidl_typesupport_fastrtps_c.h"
...
using _Init_Request__ros_msg_type = panda_move__srv__Init_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Init_Request__ros_msg_type * ros_message = static_cast<const _Init_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: scale
  {
    ...
    auto array_ptr = ros_message->scale.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  void * untyped_ros_message)
{
  ...
  _Init_Request__ros_msg_type * ros_message = static_cast<_Init_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: activated_object
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
  ...
  // Field name: scale
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->scale.data) {
      geometry_msgs__msg__Vector3__Sequence__fini(&ros_message->scale);
    }
    if (!geometry_msgs__msg__Vector3__Sequence__init(&ros_message->scale, size)) {
      fprintf(stderr, "failed to create array for field 'scale'");
      return false;
    }
    auto array_ptr = ros_message->scale.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_panda_move__srv__Init_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Init_Request__ros_msg_type * ros_message = static_cast<const _Init_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Init_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_panda_move__srv__Init_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_panda_move
size_t max_serialized_size_panda_move__srv__Init_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = panda_move__srv__Init_Request;
    is_plain =
      (
...
static size_t _Init_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_panda_move__srv__Init_Request(
...
static message_type_support_callbacks_t __callbacks_Init_Request = {
  "panda_move::srv",
  "Init_Request",
...
static rosidl_message_type_support_t _Init_Request__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Init_Request,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_move, srv, Init_Request)() {
  return &_Init_Request__type_support;
}
...
using _Init_Response__ros_msg_type = panda_move__srv__Init_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Init_Response__ros_msg_type * ros_message = static_cast<const _Init_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: init_state
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Init_Response__ros_msg_type * ros_message = static_cast<_Init_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: init_state
  {
    cdr >> ros_message->init_state;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_panda_move
size_t get_serialized_size_panda_move__srv__Init_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Init_Response__ros_msg_type * ros_message = static_cast<const _Init_Response__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Init_Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_panda_move__srv__Init_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_panda_move
size_t max_serialized_size_panda_move__srv__Init_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = panda_move__srv__Init_Response;
    is_plain =
      (
...
static size_t _Init_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_panda_move__srv__Init_Response(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_Init_Response = {
  "panda_move::srv",
  "Init_Response",
...
static rosidl_message_type_support_t _Init_Response__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Init_Response,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_move, srv, Init_Response)() {
  return &_Init_Response__type_support;
}
...
static service_type_support_callbacks_t Init__callbacks = {
  "panda_move::srv",
  "Init",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_move, srv, Init_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_move, srv, Init_Response)(),
...
static rosidl_service_type_support_t Init__handle = {
  rosidl_typesupport_fastrtps_c__identifier,
  &Init__callbacks,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_move, srv, Init)() {
  return &Init__handle;
}
