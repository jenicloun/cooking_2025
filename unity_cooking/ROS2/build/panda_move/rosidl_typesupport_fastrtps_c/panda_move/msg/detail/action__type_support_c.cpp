...
#include "panda_move/msg/detail/action__rosidl_typesupport_fastrtps_c.h"
...
using _Action__ros_msg_type = panda_move__msg__Action;
...
static uint32_t _Action__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_panda_move__msg__Action(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = panda_move__msg__Action;
    is_plain =
      (
...
static size_t _Action__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_panda_move__msg__Action(
