...
#include "panda_move/srv/detail/action_sequences__type_support.h"
...
static const _ActionSequences_Request_type_support_symbol_names_t _ActionSequences_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_move, srv, ActionSequences_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, panda_move, srv, ActionSequences_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, panda_move, srv, ActionSequences_Request)() {
  return &::panda_move::srv::rosidl_typesupport_c::ActionSequences_Request_message_type_support_handle;
}
...
static const _ActionSequences_Response_type_support_symbol_names_t _ActionSequences_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_move, srv, ActionSequences_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, panda_move, srv, ActionSequences_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, panda_move, srv, ActionSequences_Response)() {
  return &::panda_move::srv::rosidl_typesupport_c::ActionSequences_Response_message_type_support_handle;
}
...
static const _ActionSequences_type_support_symbol_names_t _ActionSequences_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_move, srv, ActionSequences)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, panda_move, srv, ActionSequences)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, panda_move, srv, ActionSequences)() {
  return &::panda_move::srv::rosidl_typesupport_c::ActionSequences_service_type_support_handle;
}
