...
#include "panda_move/msg/detail/execution_check__type_support.h"
...
static const _ExecutionCheck_type_support_symbol_names_t _ExecutionCheck_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_move, msg, ExecutionCheck)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, panda_move, msg, ExecutionCheck)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, panda_move, msg, ExecutionCheck)() {
  return &::panda_move::msg::rosidl_typesupport_c::ExecutionCheck_message_type_support_handle;
}
