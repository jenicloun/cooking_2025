...
#include "panda_move/msg/detail/action__type_support.h"
...
static const _Action_type_support_symbol_names_t _Action_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_move, msg, Action)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, panda_move, msg, Action)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, panda_move, msg, Action)() {
  return &::panda_move::msg::rosidl_typesupport_c::Action_message_type_support_handle;
}
