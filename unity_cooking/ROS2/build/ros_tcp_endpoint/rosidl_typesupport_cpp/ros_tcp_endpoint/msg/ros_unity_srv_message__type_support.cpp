...
static const _RosUnitySrvMessage_type_support_symbol_names_t _RosUnitySrvMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_tcp_endpoint, msg, RosUnitySrvMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_tcp_endpoint, msg, RosUnitySrvMessage)),
  }
};
...
{
  return &::ros_tcp_endpoint::msg::rosidl_typesupport_cpp::RosUnitySrvMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_tcp_endpoint, msg, RosUnitySrvMessage)() {
  return get_message_type_support_handle<ros_tcp_endpoint::msg::RosUnitySrvMessage>();
}
