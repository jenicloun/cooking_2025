...
from panda_move.panda_move.task_planning.searcher import AStarSearcher
from panda_move.panda_move.task_planning.planner import ForwardPlanner
from panda_move.panda_move.task_planning.domain import *
from panda_move.panda_move.task_planning.problem import StripsProblem
from panda_move.panda_move.object_level_motion import ObjectLevelMotion
import panda_move.panda_move.sample.club_sandwich
import panda_move.panda_move.sample.tuna_sandwich
import panda_move.panda_move.sample.greek_salad
import panda_move.panda_move.sample.shrimp_salad

import panda_move.panda_move.sample.test_33_predict2_v2
import panda_move.panda_move.sample.test_49_predict2_v2
import panda_move.panda_move.sample.test_80_predict2_v2
import panda_move.panda_move.sample.test_15_predict3_v2
...
class PandaMoveNode(Node):
    ...
    def main_execution(self):
        # 예제: 하나의 샘플 수행
        sandwich = panda_move.sample.greek_salad
